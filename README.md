# Freizet Stuttgart OpenAPI Specification
[![Build Status](https://travis-ci.org/benjamindonan/Freizeit-Stuttgart.svg?branch=master)](https://travis-ci.org/benjamindonan/Freizeit-Stuttgart)
...
6. If you did everything correct, https://benjamindonan.github.io/Freizeit-Stuttgart/ will lead to your new docs
...
- Documentation(ReDoc): https://benjamindonan.github.io/Freizeit-Stuttgart/
- SwaggerUI: https://benjamindonan.github.io/Freizeit-Stuttgart/swagger-ui/
- Look full spec:
    + JSON https://benjamindonan.github.io/Freizeit-Stuttgart/swagger.json
    + YAML https://benjamindonan.github.io/Freizeit-Stuttgart/swagger.yaml
- Preview spec version for branch `[branch]`: https://benjamindonan.github.io/Freizeit-Stuttgart/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://benjamindonan.github.io/Freizeit-Stuttgart/ with url from the message: `Server started <url>`
